<?php
    ...
    $marinavvGallery = [
        [
            ...
            "alt" => "Ven y quédate en la Marina V&amp;V, la mejor de cancún."
        ],
        [
        ...
        [
            ...
            "alt" => "Disfruta de los mejores articulos en la tienda de la Marina V&amp;V."
        ],
        [
            "class" => "grid-item--height2",
            "img" => "dist/images/marinavv-gallery-5.jpg",
            "imgThumbnail" => "dist/images/marinavv-gallery-thumbnail-5.jpg",
            "alt" => "Las mejores embarcaciones en la Marina V&amp;V, ven y cotiza con nosotros."
        ],
        [
            "class" => "grid-item--height2",
    ...
    $marinavvContact = [
        ...
        "alt" => "Cotiza con nosotros y quétade en la mejor marina del caribe.",
        "btn" => [
            "text" => "Contáctanos",
            "link" => "contact"
        ]
